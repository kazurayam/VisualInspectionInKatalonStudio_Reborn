...
- [Examples in Katalon Studio](#examples-in-katalon-studio)
  ...
  - [Sample4: Navigating multiple URLs in Twins mode](#sample4-navigating-multiple-urls-in-twins-mode)
    ...
    - [(3) Shutting down Flarkr](#3-shutting-down-flarkr)
    - [(4) Initializing Database in the web app](#4-initializing-database-in-the-web-app)
    - [(5) What is Flaskr?](#5-what-is-flaskr)
